...
let game, player, controls, center, platform, timerText, healthbar;
let counter = 0;
let health = 2;
...
class GameScene extends Phaser.Scene {
    ...
    preload() {
        ...
        this.load.spritesheet("health", "./assets/health.png", { frameWidth: 150, frameHeight: 28 });
    }
